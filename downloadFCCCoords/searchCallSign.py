...
def searchCallSign(CallSign):
    # Create the URL send the request and save the response to a variable
    url = 'https://www.fccinfo.com/CMDProULSLookup.php?sBASService=Microwave&tabTextBox1=' + str(CallSign) + '&tabSearchType=Call+Sign+Search'
